...
<header class="gridMargin">
    <nav>
        <figure>
            <a href="<?php echo esc_url( home_url( '/' ) ); ?>" title="Logotipo Zap Peças Automotivas">
                <img src="<?php echo esc_url( get_template_directory_uri() . '/assets/images/logotipo-zap-pecas.svg' ); ?>" alt="Logotipo Zap Peças Automotivas">
            </a>
	</figure>
